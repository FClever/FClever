...
import cn.hnhczn.app.commonsdk.http.SSLSocketClient;
import cn.hnhczn.app.commonsdk.imgaEngine.Strategy.CommonGlideImageLoaderStrategy;
...
public class GlobalConfiguration implements ConfigModule {
    ...
    public void applyOptions(Context context, GlobalConfigModule.Builder builder) {
        ...
        builder.baseurl(Api.MAIN_DOMAIN)
