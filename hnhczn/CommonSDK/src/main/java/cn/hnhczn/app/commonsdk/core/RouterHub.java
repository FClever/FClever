...
public interface RouterHub {
    ...
    String APP_ERRORACTIVITY = APP + "/ErrorActivity";

    /*
     * 海创智能分组
     * */
    String HNHCZN_SERVICE_HNHCZNSERVICE = HNHCZN + SERVICE + "/HnhcznInfoService";

    String HNHCZN_HOMEACTIVITY = HNHCZN + "/HnhcznHomeActivity";
}
